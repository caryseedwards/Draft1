...
import gui.CirclePackingPanel;
import gui.RecursivePanel;
import gui.SierpinskiPanel;
...
public class ValidateTest {
    ...
    public void testValidateRecursiveParamsPanelWithValidInputs() {
        ...
        assertEquals("", Validate.validateRecursiveParamsPanel(mockPanel));
    }
    ...
    public void testValidateRecursiveParamsPanelWithNegativeDepth() {
        ...
        assertEquals("Recursive depth must be a positive integer.", Validate.validateRecursiveParamsPanel(mockPanel));
    }
    ...
    public void testValidateRecursiveParamsPanelWithEmptyStartX() {
        ...
        assertEquals("CenterX must be an integer.", Validate.validateRecursiveParamsPanel(mockPanel));
    }
    ...
    public void testValidateRecursiveParamsPanelWithNonIntegerRadius() {
        ...
        assertEquals("Initial radius must be an integer.", Validate.validateRecursiveParamsPanel(mockPanel));
    }
    ...
    public void testValidateCirclePackingParamsPanelWithValidInputs() {
        ...
        assertEquals("", Validate.validateCirclePackingParamsPanel(mockPanel));
    }
    ...
    public void testValidateCirclePackingParamsPanelWithZeroMaxAttempts() {
        ...
        assertEquals("MaxAttempts must be a positive integer.", Validate.validateCirclePackingParamsPanel(mockPanel));
    }
    ...
    public void testValidateCirclePackingParamsPanelWithZeroBoundaryLineWidth() {
        ...
        assertEquals("Boundary Line Width must be a positive integer.", Validate.validateCirclePackingParamsPanel(mockPanel));
    }
    ...
    public void testValidateSierpinskiParamsPanelWithValidInputs() {
        ...
        assertEquals("", Validate.validateSierpinskiParamsPanel(mockPanel));
    }

    @Test
    public void testValidateSierpinskiParamsPanelWithInvalidSize() {
        SierpinskiPanel mockPanel = createMockSierpinskiPanel("150", "150", "4", "-200", "2");
        assertEquals("Polygon Size must be a positive integer.", Validate.validateSierpinskiParamsPanel(mockPanel));
    }
    ...
    public void testValidateSierpinskiParamsPanelWithZeroDepth() {
        ...
        assertEquals("Depth must be a positive integer.", Validate.validateSierpinskiParamsPanel(mockPanel));
    }
    ...
    public void testValidateSierpinskiParamsPanelWithNegativeLineWidth() {
        ...
        assertEquals("Shape Line Width must be a positive integer.", Validate.validateSierpinskiParamsPanel(mockPanel));
    }
}
