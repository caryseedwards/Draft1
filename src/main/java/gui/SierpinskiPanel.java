...
public class SierpinskiPanel {
    ...
    private Color fillColour = new Color(255, 255, 255, 255); // Default white
    private Color lineColour = new Color(0, 0, 0, 255); // Default black
    private final TextField lineWidthTextField = new TextField("1.0", 5);
    ...
    private void setupPanel() {
        ...
        addLabelAndChoice(gbc, shapeTypeChoice, new String[]{"Circle", "Square", "Triangle", "Hexagon"}, gridy++);
